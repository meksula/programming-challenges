...
public class Square extends AvailableShapes {
    private Polygon polygon;
    private final double[] DEFAULT_POINTS = {100, 100, 100, 200, 200, 200, 200, 100, 100, 100};
    ...
    public Polygon scale(double scaleFactor) {
        ...
        arguments[3] =+ scaleFactor;
        arguments[5] =+ scaleFactor;
